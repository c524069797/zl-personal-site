...
export const frontendResume: ResumeData = {
  ...
  summary:
    "近 5 年 Web 开发经验，覆盖企业级中后台、复杂表单向导、可视化大屏、内容型站点与跨端移动应用等多种形态。参与内部智能客服上线，开发流式回答、引用展示和转人工交互；在个人项目中实践 Agent 审批交互、直播电商 Web 与 Flutter 页面。",
  ...
  projects: [
    {
      ...
      bullets: [
        {
          label: "流程抽象",
          text: "主导备份/恢复向导框架设计与实现，基于工厂模式 + Context + Proxy 支持多种资源类型动态注入与跨步骤状态共享；新资源接入从「复制改造整套页面」简化为「注册配置 + 差异步骤」，开发周期从 2 周缩短到 2 天。",
        },
        {
          label: "组件体系",
